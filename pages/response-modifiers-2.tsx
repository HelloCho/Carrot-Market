...
export default function Example() {
    return (
        ...
        <div className="bg-slate-400 py-20 px-10 grid gap-10 md:place-content-center md:grid-cols-2 lg:grid-cols-2  xl:grid-cols-3 min-h-screen">
            {/* Layout #1 */}
            <div className="bg-white flex flex-col justify-between p-6 rounded-3xl shadow-xl">
                ...
                <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-300 focus:text-red-500">
                    Checkout
                </button>
            </div>
            ...
            <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
                <div className="bg-blue-500 portrait:bg-indigo-300 landscape:bg-teal-300 p-6 pb-14 xl:pb-56">
            ...
            {/* Layout #3 */}
            <div className="bg-white p-6 rounded-2xl shadow-xl md:col-span-2 xl:col-span-1">
